...
WINDAGE_COEFF = 0
source_file_path = r"Z:\ADVECTOR\sources\uniform\T1-500_RD2020.nc"
OUTPUTFILE_PATH = f"Y:\PROJECTS\TRAPs\ADVECTOR\outputs"
OUTPUTFILE_PATH = f"Y:\PROJECTS\TRAPs\ADVECTOR\outputs\\advector_v1_2d_globcurrent_uniform_GPGP_1x_wind_{WINDAGE_COEFF}_{ADVECTION_START.year}_{ADVECTION_END.year}"
...
if __name__ == "__main__":
    ...
    download_and_process_currents(download_path, ADVECTION_START, ADVECTION_END)
    download_and_process_currents(download_path, ADVECTION_START, ADVECTION_END)
